    ...
    return (
        <section id="origin" ref={sectionRef} className="relative min-h-[300vh] bg-black text-white flex flex-col md:flex-row border-t border-white/5 z-10">
            ...
            <div className="w-full md:w-1/2 h-screen flex items-center justify-center story-title-container bg-black z-20">
                <div className="text-left px-12 md:px-24 w-full">
                    <span className="text-gold-accent font-display tracking-[0.4em] uppercase text-[10px] mb-6 block">Our Origin</span>
                    <h2 className="text-7xl md:text-9xl font-bold font-display tracking-tighter leading-none text-white overflow-hidden">
            ...
            <div className="story-content w-full md:w-1/2 px-12 md:px-24 py-[50vh] flex flex-col gap-[60vh] relative z-10">
                <div className="story-text max-w-lg">
                    <p className="text-4xl md:text-6xl font-display font-medium leading-[1.1] mb-8">
